        ...
        players_team_history.append(
            {
                ...
                else text_to_num(player_market_value.replace("\u20ac", "")),
            }
        )
...
def crawl_players_list(base_url, headers):
    ...
    with open(
        "unique_players_initial_data.json", "w"
    ) as json_unique_players_initial_data:
        json.dump(
            unique_players_initial_data, json_unique_players_initial_data, indent=4
        )
